...
if __name__ == "__main__" : 
    ...
    tStart = Date('10 May') # wherever the previous simulation ended
    tEnd = Date('18 May')   # whenever you want to run the simulation till
    ...
    with open('series1.pkl', 'wb') as fd : 
        pickle.dump(seriesOfSeries, fd)

    with open('var1.pkl', 'wb') as fd : 
