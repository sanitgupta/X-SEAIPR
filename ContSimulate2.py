...
if __name__ == "__main__" : 
    ...
    with open('series1.pkl', 'rb') as fd : 
        seriesOfSeries = pickle.load(fd)

    with open('var1.pkl', 'rb') as fd : 
    ...
    tStart = Date('18 May') # wherever the previous simulation ended
    tEnd = Date('26 May')   # whenever you want to run the simulation till
    ...
    with open('series2.pkl', 'wb') as fd : 
        pickle.dump(seriesOfSeries, fd)

    with open('var2.pkl', 'wb') as fd : 
